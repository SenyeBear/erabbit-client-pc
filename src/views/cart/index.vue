              ...
              <td>
                <div class="goods">
                  ...
                  <div>
                    ...
                    <!-- 选择规格组件  goods.skuId是原来的skuId用于合并新的购物车信息，$event是购物车组件传入的更改后的sku信息（只有5个字段 所以要合并）-->
...
export default {
  ...
  setup () {
    ...
    const batchDeleteCart = (isClear) => {
      Confirm({ text: `是否删除${isClear ? '失效' : '选中'}商品？` }).then(() => {
